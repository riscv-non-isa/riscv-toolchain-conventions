...
=== Policy for allocating vendor prefixes
This document lists <<vendor-prefixes-list,
the canonical RISC-V vendor prefixes>> used in open-source
projects to prevent naming collisions, especially in open-source toolchains.
It is not meant to be an official registry but rather a central place for
discussing and recording vendor prefix conventions.
...
=== Policy for including vendor extensions
This document includes
<<vendor-extensions-list, a list of RISC-V vendor extensions>>
